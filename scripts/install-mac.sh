...
echo ""
echo "YouTube authentication (recommended for transcription):"
echo "  YouTube may require a PO token for subtitle downloads."
echo "  Run: yt-artist doctor    — to check your setup"
echo "  Set: export YT_ARTIST_COOKIES_BROWSER=chrome"
echo "  Set: export YT_ARTIST_PO_TOKEN=<your-token>"
echo "  Guide: https://github.com/yt-dlp/yt-dlp/wiki/PO-Token"
echo ""
